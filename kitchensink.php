<?php include('partials/header.php'); ?>
    ...
    <section id="page" class="row" data-equalizer>
		...
		<div class="page-content large-12 columns container-box box">
			<h2 class="page-title">Kitchen Sink</h2>
			<div class="row">
	          	...
	          	<div class="entry-content">
	          		...
	          		<div>
	          			...
	          			<ul class="small-block-grid-2 large-block-grid-4">
	          				<li><img class="th" src="<?php echo $baseUrl; ?>img/dummy1.jpg"></li>
	          				<li><img class="th" src="<?php echo $baseUrl; ?>img/dummy2.jpg"></li>
	          				<li><img class="th" src="<?php echo $baseUrl; ?>img/dummy3.jpg"></li>
	          				<li><img class="th" src="<?php echo $baseUrl; ?>img/dummy4.jpg"></li>
	          			</ul>
	          			...
	          			<p><a href="#" data-dropdown="drop" class="tiny button dropdown">Tiny Dropdown Button</a><br>
	          				...
	          				<p> <a href="#" class="tiny button split">Tiny Split Button <span data-dropdown="drop"></span></a><br>
	          					...
	          					<div>
	          						...
	          						<li><a class="th" href="<?php echo $baseUrl; ?>img/clearing1.jpg"><img data-caption="Nulla vitae elit libero, a pharetra augue. Cras mattis consectetur purus sit amet fermentum." src="../assets/img/examples/comet-th-sm.jpg"></a></li>

	          						<li><a class="th" href="<?php echo $baseUrl; ?>img/clearing2.jpg"><img src="../assets/img/examples/earth-th-sm.jpg"></a></li>

	          						<li><a class="th" href="<?php echo $baseUrl; ?>img/clearing3.jpg"><img data-caption="Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus." src="../assets/img/examples/launch-th-sm.jpg"></a></li>

	          						<li><a class="th" href="<?php echo $baseUrl; ?>img/clearing4.jpg"><img src="../assets/img/examples/satelite-th-sm.jpg"></a></li>

	          						<li><a class="th" href="<?php echo $baseUrl; ?>img/clearing5.jpg"><img data-caption="Integer posuere erat a ante venenatis dapibus posuere velit aliquet." src="../assets/img/examples/space-th-sm.jpg"></a></li>
	          					</ul></div></div></div>
	          				</div>
	          				...
	          				<p><a class="button" data-dropdown="tinyDrop" href="#">Link Dropdown »</a>
	          					...
	          					<div class="f-dropdown content medium" data-dropdown-content="" id="contentDrop">
	          						...
	          						<div class="row">
	          							<div class="large-12 columns">
	          								<div class="orbit-container"><ul id="featured1" data-orbit="" data-options="timer_speed:5000;" class="orbit-slides-container" style="height: 0px;">
	          									<li class="active">
	          								...
	          								</ul><a href="#" class="orbit-prev"><span></span></a><a href="#" class="orbit-next"><span></span></a><div class="orbit-timer paused"><span></span><div class="orbit-progress"></div></div><div class="orbit-slide-number"><span></span> of <span></span></div><div class="orbit-bullets-container"><ol class="orbit-bullets"><li data-orbit-slide="0"></li><li data-orbit-slide="1"></li><li data-orbit-slide="2"></li></ol></div></div>
	          							</div>
	          						</div>
	          						...
	          						<div class="row">
	          							...
	          							<p><a href="#" data-reveal-id="firstModal" class="radius button">Example Modal…</a>
	          								...
	          								<p>The tooltips can be positioned on the <span data-tooltip="" class="has-tip" data-width="210" data-selector="tooltip-i0pbyirf0" aria-describedby="tooltip-i0pbyirf0" title="">"tip-bottom"</span>, which is the default position, <span data-tooltip="" class="has-tip tip-top noradius" data-width="210" data-selector="tooltip-i0pbyirf1" aria-describedby="tooltip-i0pbyirf1" title="">"tip-top" (hehe)</span>, <span data-tooltip="left" class="has-tip tip-left" data-width="90" title="">"tip-left"</span>, or <span data-tooltip="right" class="has-tip tip-right" data-width="120" title="">"tip-right"</span> of the target element by adding the appropriate class to them. You can even add your own custom class to style each tip differently. On a small device, the tooltips are full width and bottom aligned.</p>
	...
	<?php include('partials/request-form.php'); ?>
